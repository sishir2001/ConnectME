 ...
 */
public class SlideFragmentTwo extends Fragment {

    public SlideFragmentTwo() {
    ...
    public void onViewCreated(View view,Bundle onSavedInstances){
        ...
        dot.setSelectedItem(1,true);
        TextView textView = (TextView) view.findViewById(R.id.textViewInfo);
        // changing the text
        textView.setText(getResources().getString(R.string.page_2));
        ImageView imageView = (ImageView) view.findViewById(R.id.imageViewInfo);
        imageView.setImageResource(R.drawable.ic_pg2_img);
    }
    @Override
