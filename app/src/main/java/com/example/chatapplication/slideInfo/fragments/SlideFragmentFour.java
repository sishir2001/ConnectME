 ...
 */
public class SlideFragmentFour extends Fragment {

    public SlideFragmentFour() {
    ...
    public void onViewCreated(View view,Bundle onSavedInstances){
        ...
        dot.setSelectedItem(3,true);
        TextView textView = (TextView) view.findViewById(R.id.textViewInfo);
        // changing the text
        textView.setText(getResources().getString(R.string.page_4));
        ImageView imageView = (ImageView) view.findViewById(R.id.imageViewInfo);
        imageView.setImageResource(R.drawable.ic_pg4_img);
